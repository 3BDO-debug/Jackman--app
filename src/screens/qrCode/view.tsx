...
const QrCodeView: FC<QrCodeViewProps> = ({ navigation }) => {
  ...
  console.log("booking", triggeredBooking.status);
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={[styles.qrContainer, { marginTop: 15 }]}>
        ...
        {/* Wrapper */}
        {triggeredBooking?.status === "pending" && <PendingBooking triggeredBooking={triggeredBooking} />}
        {triggeredBooking?.status === "rejected" && <PendingBooking triggeredBooking={triggeredBooking} />}
        {triggeredBooking?.status === "approved" && <AcceptedBooking triggeredBooking={triggeredBooking} />}
